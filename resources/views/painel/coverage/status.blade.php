        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-12">
                <div class="form-group row">
                    <div class="col-md-1">  <a href="{{url('/painel/cobertura/prenha')}}" class="btn btn-outline-success btn-lg">Prenhas</a></div>
                    <div class="col-md-1">  <a href="{{url('/painel/cobertura/falha')}}" class="btn btn-outline-danger btn-lg">Falhas</a></div>
                    <div class="col-md-2">  <a href="{{url('/painel/cobertura/nao-diagnosticado')}}" class="btn btn-outline-warning btn-lg">Não Diagnosticado</a></div>
